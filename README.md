...
Descripción
El presente trabajo tiene como objetivo analizar y optimizar el proceso de solicitud de vacaciones dentro de una organización. Actualmente, este procedimiento se realiza de forma manual mediante correos electrónicos y validaciones efectuadas por el área de Recursos Humanos.
...
Año: 2026.
atura Universitaria en Programación a Distancia (UTN).
